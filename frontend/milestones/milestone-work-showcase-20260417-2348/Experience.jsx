  ...
  return (
    <div style={{ background: '#030201', cursor: 'none', userSelect: 'none', WebkitUserSelect: 'none' }}>
      ...
      <div style={{
        ...
        <img src="/logo-gold.png" alt="Mirage Studios" style={{ width: 96, opacity: 0.55 }} />
      </div>
      ...
      {SECTIONS.map((section, i) => {
        ...
        return (
          ...
          >
            <SectionComp data={section} active={activeSection === i} />
          </div>
        )
      })}
    </div>
